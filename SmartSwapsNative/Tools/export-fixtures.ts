 ...
 * cases, not a retyped subset. baseline.snapshot.json is copied through untouched - it is
 * the frozen expected output and must not be regenerated by this port.
 */
